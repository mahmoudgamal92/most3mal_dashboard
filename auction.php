                                                ...
                                                ?>
                                                    ...
                                                    <li role="presentation" class="show">
                                                        <a href="<?= '#key_' . $key ?>" role="tab" data-bs-toggle="tab">
                                                            <img class="img-fluid" src="./uploads/<?= $img ?>" alt="" style="width:px;height:100px;border-radius:10px;margin:10px">
                                                        </a>
                                                    </li>
                                    ...
                                    <div class="col-xl-9 col-lg-6  col-md-6 col-xxl-7 col-sm-12">
                                        <div class="product-detail-content">
                                            ...
                                            <div class="new-arrival-content pr">
                                                ...
                                                <p>رقم المزاد: <span class="item">
                                                        <?php echo $ad[0]['id']; ?>
                                                    </span> </p>



                                                <p>تاريخ بداية المزاد : <span class="item">
                                                        <?php echo $ad[0]['start_date']; ?>
                                                    </span> </p>



                                                <p> تاريخ نهاية المزاد : <span class="item">
                                                        <?php echo $ad[0]['end_date']; ?>
                                                    </span> </p>
